...
const char* password = "FEDCBA98765432109876543210";
...
WiFiClient serverClients[MAX_SRV_CLIENTS];	//sert a créer des serveurs de reponse pour les clients
...
void loop()
{
  serverHTML.handleClient();		// active le serveur (s'il est pas activé). voir le .cpp
  /*
  uint8_t i;
